          ...
          if [ $count -lt 2 ]
            ...
            if [ "$stat2" -lt 4000 ]
              then
                ...
                python normtest.py --DS ENZYMES --lr 0.01 --local --num-gc-layers 3 --aug random2 --seed 0 -DS_pair ENZYMES+PROTEINS -batch_size_test 128 --device 1 --amplr $l --bal1 $b --bal2 $c --ratio $r 
                sleep 10
                break
            fi
          fi
