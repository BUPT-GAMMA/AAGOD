          ...
          if [ $count -lt 2 ]
            ...
            if [ "$stat2" -lt 6000 ]
              then
                ...
                python clmd.py --DS IMDB-MULTI --lr 0.01 --local --num-gc-layers 3 --aug random2 --seed 0 -DS_pair IMDB-MULTI+IMDB-BINARY -batch_size_test 128 --device 2 --amplr $l --bal1 $b --bal2 $c --ratio $r 
                sleep 5
                break
            fi
          fi
